...
#'
#' Any matrix-like `network` argument will be coerced to a \code{\link[Matrix:dgCMatrix-class]{dgCMatrix}}.
#'
...
#'
#' While it would be nice to return an [igraph][igraph::igraph] object when given a `network` of that class,
