...
We can compute the convex hull of these eight clusters' community profiles.
...
Hence we compute Euclidean distances from every journal profile to the convex hull of community profiles.
